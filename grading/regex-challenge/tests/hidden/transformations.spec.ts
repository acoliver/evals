...
describe('Transformations', () => {
  it('should capitalize sentences with messy spacing', () => {
  ...
  it('should extract urls without trailing punctuation', () => {
  ...
  it('should enforce https without touching existing https links', () => {
  ...
  it('should rewrite docs urls while skipping dynamic paths', () => {
    const text = [
  ...
  it('should extract year or returns N/A when invalid', () => {
